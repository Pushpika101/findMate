...
const ProfileScreen = ({ navigation }) => {
  ...
  const styles = useThemedStyles((colors) => ({
    ...
    scrollView: { flex: 1 },
    profileCard: { backgroundColor: colors.kk2, marginHorizontal: 20, marginTop: 20, borderRadius: 16, padding: 24, alignItems: 'center', shadowColor: colors.black, shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 8, elevation: 4 },
    ...
    userName: { fontSize: 24, fontWeight: 'bold', color: colors.textInverse, marginBottom: 4 },
